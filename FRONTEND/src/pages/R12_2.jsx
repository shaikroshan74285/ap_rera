...
// Import datasets for Rajamahendravaram region
import agentData from '../data/R12_2_Agent.json';
import projectData from '../data/R12_2_Project.json';
...
const R12_2 = () => {
  ...
  const handleGetDetails = () => {
    // 1. Select the source file based on your JSON keys
    let sourceData = appType === 'Project' 
      ? projectData["RegionWise Project DetailsRajah"] 
      : agentData["RegionWise Agent DetailsRajahmu"];
  ...
  const downloadCSV = () => {
    ...
    link.download = `RegionWise_Report_R12_2_${activeType}.csv`;
    link.click();
  };
  ...
  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white">Home</Link> / <Link to="/mis-reports" className="text-white">MIS Reports</Link> / Region Wise Reports R12.2 - Rajamahendravaram
      </div>

      <div className="report-card-container">
        <h2 className="report-title-left">Region Wise Report: <strong>R12.2 - Rajamahendravaram</strong></h2>
        <hr className="title-underline" />

        {/* Filter Section matching image_073478.png */}
