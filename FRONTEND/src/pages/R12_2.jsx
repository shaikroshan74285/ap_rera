...
const R12_2 = () => {
  ...
  const downloadExcel = () => {
    ...
    XLSX.writeFile(workbook, `RegionWise_Report_R12_2_${activeType}.xlsx`);
  };
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text(`Region Wise Report: ${activeType} - Rajamahendravaram`, 14, 15);
    ...
    doc.save(`RegionWise_Report_R12_2_${activeType}.pdf`);
  };
