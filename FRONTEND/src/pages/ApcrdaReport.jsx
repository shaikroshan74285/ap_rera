...
const ApcrdaReport = () => {
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "APCRDA Projects");
    XLSX.writeFile(workbook, "APCRDA_Project_Report.xlsx");
  };
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("APCRDA Wise Project Details", 14, 15);
    ...
    autoTable(doc, {
      head: [["S.No.", "CRDA Name", "Project Name", "Type", "Name Type", "Name", "Submission Date", "Status"]],
      body: tableRows,
      startY: 22,
      styles: { fontSize: 8 },
    ...
    doc.save("APCRDA_Full_Project_Report.pdf");
  };

  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline" target="_blank" rel="noopener noreferrer">Home</Link> / <Link to="/mis-reports" className="text-white underline" target="_blank" rel="noopener noreferrer">MIS Reports</Link> / APCRDA Wise Project Details
      </div>
