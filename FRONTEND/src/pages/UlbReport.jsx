...
import ulbData from '../data/UlbData.json';
...
const UlbReport = () => {
  ...
  const allData = ulbData["ULB(110) Wise Project Details"] || [];
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "ULB Projects");
    XLSX.writeFile(workbook, "ULB_Wise_Project_Report.xlsx");
  };
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("ULB Wise Project Details", 14, 15);
    ...
    autoTable(doc, {
      head: [["S.No.", "ULB Name", "Project Name", "Type", "Name Type", "Name", "Submission Date", "Status"]],
      body: tableRows,
      startY: 22,
      styles: { fontSize: 8 },
    ...
    doc.save("ULB_Wise_Full_Project_Report.pdf");
  };

  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline" target="_blank" rel="noopener noreferrer">Home</Link> / <Link to="/mis-reports" className="text-white underline" target="_blank" rel="noopener noreferrer">MIS Reports</Link> / ULB Wise Project Details
      </div>

      <div className="report-card-container">
        <h2 className="report-title">ULB Wise Project Details</h2>
