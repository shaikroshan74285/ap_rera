...
import layoutData from '../data/LayoutForPlotsData.json';
...
const LayoutForPlotsReport = () => {
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Plots Development");
    XLSX.writeFile(workbook, "Layout_Plots_Report_R3_6.xlsx");
  };
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Type Of Housing - R3.6 - Layouts-for Plot Development Report", 14, 15);
    ...
    doc.save("Layout_Plots_Development_Full_Report_R3_6.pdf");
  };

  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline" target="_blank" rel="noopener noreferrer">Home</Link> / <Link to="/mis-reports" className="text-white underline" target="_blank" rel="noopener noreferrer">MIS Reports</Link> / Type of Housing - R3.6 - Layouts-for Plot Development Report
      </div>
