...
const MixedReport = () => {
  // Accessing the data using the exact key provided in your latest JSON sample
  // We use a fallback to check both common versions of the key
  ...
  const downloadCSV = () => {
    ...
    link.download = "Mixed_Report_R3_5.csv";
    link.click();
  };
  ...
  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline">Home</Link> / <Link to="/mis-reports" className="text-white underline">MIS Reports</Link> / Type of Housing - R3.5 - Mixed Report
      </div>
