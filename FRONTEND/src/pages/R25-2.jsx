...
// const allData = []; // no dummy data
  ...
  const downloadCSV = () => {
    ...
    link.download = "Change Request Status_Report_R25_2.csv";
    link.click();
  };
  ...
  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline">Home</Link> / <Link to="/mis-reports" className="text-white underline">MIS Reports</Link> / R25.2 Change Request Status
      </div>

      <div className="report-card-container">
        <h2 className="report-title">Change Request Status</h2>
