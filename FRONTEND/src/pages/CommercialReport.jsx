...
const CommercialReport = () => {
  ...
  const allData = commercialData["Housing Type-R3.4 - Commercial "] || [];
  ...
  const downloadExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Commercial Projects");
    XLSX.writeFile(workbook, "Commercial_Report_R3_4.xlsx");
  };
  ...
  const downloadPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Type Of Housing - R3.4 - Commercial Report", 14, 15);
    ...
    doc.save("Commercial_Full_Report_R3_4.pdf");
  };

  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline" target="_blank" rel="noopener noreferrer">Home</Link> / <Link to="/mis-reports" className="text-white underline" target="_blank" rel="noopener noreferrer">MIS Reports</Link> / Type of Housing - R3.4 - Commercial Report
      </div>

      <div className="report-card-container">
        <h2 className="report-title">Type Of Housing - R3.4 - Commercial Report</h2>
