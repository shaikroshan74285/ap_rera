...
import commercialData from '../data/CommercialData.json'; // Ensure this path matches your setup
...
const CommercialReport = () => {
  ...
  const downloadCSV = () => {
    ...
    link.download = "Commercial_Report_R3_4.csv";
    link.click();
  };

  return (
    <div className="report-page-wrapper">
      {/* Breadcrumb matching UI */}
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline">Home</Link> / <Link to="/mis-reports" className="text-white underline">MIS Reports</Link> / Type of Housing - R3.4 - Commercial Report
      </div>
      ...
      <div className="report-card-container">
        ...
        {/* Data Table with specific columns for Commercial Reports */}
