...
const R12_3 = () => {
  ...
  const downloadCSV = () => {
    ...
    link.download = `RegionWise_Report_R12_3_${activeType}.csv`;
    link.click();
  };
  ...
  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white">Home</Link> / <Link to="/mis-reports" className="text-white">MIS Reports</Link> / Region Wise Reports R12.3 - Guntur
      </div>
