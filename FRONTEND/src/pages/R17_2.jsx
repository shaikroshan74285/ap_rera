...
import pendingAgentData from '../data/R17_2_Data.json'; // Ensure this matches your JSON filename

const R17_2 = () => {
  // Map to the "Sheet1" key from your JSON sample
  ...
  const downloadCSV = () => {
    ...
    link.download = "Pending_Agents_Report_R17_2.csv";
    link.click();
  };
  ...
  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline">Home</Link> / <Link to="/mis-reports" className="text-white underline">MIS Reports</Link> / R17.2 Pending Agents Report
      </div>
