...
const ApartmentsReport = () => {
  ...
  const downloadCSV = () => {
    ...
    link.download = "Apartments_Report_R3_1.csv";
    link.click();
  };
  ...
  return (
    <div className="report-page-wrapper">
      <div className="breadcrumb-blue no-print">
        You are here : <Link to="/" className="text-white underline">Home</Link> / <Link to="/mis-reports" className="text-white underline">MIS Reports</Link> / Type of Housing - R3.1 - Apartments Report
      </div>
